  ...
  return (
    <>
      <div className="mainPaymentPage">
        <div className="leftpaymentSideBar">
            <Sidebar/>
        </div>
        <div className="paymentCotainer">
          <div class="modal">
            <form class="form" onSubmit={handleSubmit}>
              <div class="credit-card-info--form">
                ...
                <div class="payment--options">
                  <button type="button" name="paypal" style={{cursor:'pointer'}}>
                    <svg
                  ...
                  <button type="button" name="apple-pay" style={{paddingLeft:'20px',cursor:'pointer'}}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink"
                      version="1.1"
                  ...
                  <button type="button" name="google-pay" style={{cursor:'pointer'}}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="80"
                      height="39"
