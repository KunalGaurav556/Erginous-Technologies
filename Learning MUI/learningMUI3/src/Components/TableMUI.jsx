...
import {TableContainer,Table,Paper,TableBody,TableHead,TableRow,TableCell} from '@mui/material'


const TableMUI = () => {
  return (
    <>
        <TableContainer className='tableContainer' component={Paper} sx={{maxHeight:'400px', display:'flex',justifyContent:'center'}}>
            <Table>
                <TableHead className='tableHead' >
                    <TableRow >
                        <TableCell className='tableHead-tableCell' sx={{color:'white'}}>ID</TableCell>
                        <TableCell className='tableHead-tableCell' sx={{color:'white'}}>Name</TableCell>
                        <TableCell className='tableHead-tableCell' sx={{color:'white'}}>Email</TableCell>
                        <TableCell className='tableHead-tableCel' sx={{color:'white'}}>Post ID</TableCell>
                        <TableCell className='tableHead-tableCell' sx={{color:'white', fontWeight:'bold',textAlign:'center'}}>Body</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {
