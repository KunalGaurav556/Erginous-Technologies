...
const SignUp = () => {
  ...
  return (
    <>
      ...
      <div className="adminSignUp" style={{display:'flex',justifyContent:'end'}}>
          <div><UserLoginBtn/></div>
      </div>
        <div className="mainSignUp">
          ...
          /> */}
              <h2 style={{color:'green', fontFamily:"cursive",fontWeight:'600'}}>Erginous Tech..</h2>
