        ...
        <Stack direction={"row"} className="upperSideCommunitySection">
          ...
          <Stack className="teliMainCommunity">
            <Stack className="teligramCommunity">
              ...
              <Stack className="teligramIconCommunity">
                <SendIcon sx={{ fontSize: "80px",color:'rgb(0, 229, 255)' }} />
                <Typography className="" fontSize={"18px"} fontWeight={"600"} color="rgb(0, 229, 255)">
                  Teligram
                </Typography>
              </Stack>
            </Stack>
          ...
          <Stack className="teliMainCommunity Youtube">
            <Stack className="teligramCommunity">
              ...
              <Stack className="YoutubeIconCommunity">
                <YouTubeIcon sx={{ fontSize: "50px",color:'rgb(255, 64, 129)' }} />
                <Typography className="" fontSize={"18px"} fontWeight={"600"} color="rgb(255, 64, 129)">
                  Teligram
                </Typography>
              </Stack>
            </Stack>
          ...
          <Stack className="teliMainCommunity podcast">
            <Stack className="teligramCommunity">
              ...
              <Stack className="YoutubeIconCommunity">
                <PodcastsIcon sx={{ fontSize: "50px",color:'rgb(255, 64, 129)' }} />
                <Typography className="" fontSize={"18px"} fontWeight={"600"} color="rgb(255, 64, 129)">
                  Teligram
                </Typography>
              </Stack>
        ...
        <Stack className=" Twitter">
          ...
          <Stack className="teliMainCommunity Mail">
            <Stack className="teligramCommunity">
              ...
              <Stack className="YoutubeIconCommunity">
                <MailIcon sx={{ fontSize: "50px",color:'rgb(255, 64, 129)' }} />
                <Typography className="" fontSize={"18px"} fontWeight={"600"} color="rgb(255, 64, 129)">
                  Teligram
                </Typography>
              </Stack>
          ...
          <Stack className="teliMainCommunity facebook">
            <Stack className="teligramCommunity">
              ...
              <Stack className="teligramIconCommunity">
                <FacebookIcon sx={{ fontSize: "80px",color:'rgb(0, 229, 255)' }} />
                <Typography className="" fontSize={"18px"} fontWeight={"600"} color="rgb(0, 229, 255)">
                  Teligram
                </Typography>
              </Stack>
